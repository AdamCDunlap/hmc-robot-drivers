...
(cl:in-package ardrone_mudd-srv)
...
(cl:defmethod cl:initialize-instance :after ((m <Control-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Control-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name ardrone_mudd-srv:<Control-request> is deprecated: use ardrone_mudd-srv:Control-request instead.")))

(cl:ensure-generic-function 'command-val :lambda-list '(m))
(cl:defmethod command-val ((m <Control-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader ardrone_mudd-srv:command-val is deprecated.  Use ardrone_mudd-srv:command instead.")
  (command m))
...
(cl:defmethod cl:initialize-instance :after ((m <Control-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Control-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name ardrone_mudd-srv:<Control-response> is deprecated: use ardrone_mudd-srv:Control-response instead.")))

(cl:ensure-generic-function 'result-val :lambda-list '(m))
(cl:defmethod result-val ((m <Control-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader ardrone_mudd-srv:result-val is deprecated.  Use ardrone_mudd-srv:result instead.")
  (result m))
