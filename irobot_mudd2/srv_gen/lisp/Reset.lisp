...
(cl:defmethod cl:initialize-instance :after ((m <Reset-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Reset-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name irobot_mudd-srv:<Reset-request> is deprecated: use irobot_mudd-srv:Reset-request instead.")))

(cl:ensure-generic-function 'reset-val :lambda-list '(m))
(cl:defmethod reset-val ((m <Reset-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader irobot_mudd-srv:reset-val is deprecated.  Use irobot_mudd-srv:reset instead.")
  (reset m))
...
(cl:defmethod cl:initialize-instance :after ((m <Reset-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Reset-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name irobot_mudd-srv:<Reset-response> is deprecated: use irobot_mudd-srv:Reset-response instead.")))
