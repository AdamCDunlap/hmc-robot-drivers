...
(cl:defmethod cl:initialize-instance :after ((m <Demo-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Demo-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name irobot_mudd-srv:<Demo-request> is deprecated: use irobot_mudd-srv:Demo-request instead.")))

(cl:ensure-generic-function 'demo-val :lambda-list '(m))
(cl:defmethod demo-val ((m <Demo-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader irobot_mudd-srv:demo-val is deprecated.  Use irobot_mudd-srv:demo instead.")
  (demo m))
...
(cl:defmethod cl:initialize-instance :after ((m <Demo-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Demo-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name irobot_mudd-srv:<Demo-response> is deprecated: use irobot_mudd-srv:Demo-response instead.")))
