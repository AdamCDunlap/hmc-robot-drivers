...
(cl:defmethod cl:initialize-instance :after ((m <Turn-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Turn-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name irobot_mudd-srv:<Turn-request> is deprecated: use irobot_mudd-srv:Turn-request instead.")))

(cl:ensure-generic-function 'clear-val :lambda-list '(m))
(cl:defmethod clear-val ((m <Turn-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader irobot_mudd-srv:clear-val is deprecated.  Use irobot_mudd-srv:clear instead.")
  (clear m))

(cl:ensure-generic-function 'turn-val :lambda-list '(m))
(cl:defmethod turn-val ((m <Turn-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader irobot_mudd-srv:turn-val is deprecated.  Use irobot_mudd-srv:turn instead.")
  (turn m))
...
(cl:defmethod cl:initialize-instance :after ((m <Turn-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Turn-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name irobot_mudd-srv:<Turn-response> is deprecated: use irobot_mudd-srv:Turn-response instead.")))
