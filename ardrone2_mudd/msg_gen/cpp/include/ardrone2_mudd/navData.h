/* Auto-generated by genmsg_cpp for file /home/robotics/ros_workspace/hmc-robot-drivers/ardrone2_mudd/msg/navData.msg */
#ifndef ARDRONE2_MUDD_MESSAGE_NAVDATA_H
#define ARDRONE2_MUDD_MESSAGE_NAVDATA_H
#include <string>
#include <vector>
#include <map>
#include <ostream>
...
private:
  static const char* __s_getDataType_() { return "ardrone2_mudd/navData"; }
public:
...
public:
  ...
  typedef boost::shared_ptr< ::ardrone2_mudd::navData_<ContainerAllocator> > Ptr;
  typedef boost::shared_ptr< ::ardrone2_mudd::navData_<ContainerAllocator>  const> ConstPtr;
  boost::shared_ptr<std::map<std::string, std::string> > __connection_header;
}; // struct navData
typedef  ::ardrone2_mudd::navData_<std::allocator<void> > navData;

typedef boost::shared_ptr< ::ardrone2_mudd::navData> navDataPtr;
typedef boost::shared_ptr< ::ardrone2_mudd::navData const> navDataConstPtr;


template<typename ContainerAllocator>
std::ostream& operator<<(std::ostream& s, const  ::ardrone2_mudd::navData_<ContainerAllocator> & v)
{
  ros::message_operations::Printer< ::ardrone2_mudd::navData_<ContainerAllocator> >::stream(s, "", v);
  return s;}
...
{
template<class ContainerAllocator> struct IsMessage< ::ardrone2_mudd::navData_<ContainerAllocator> > : public TrueType {};
template<class ContainerAllocator> struct IsMessage< ::ardrone2_mudd::navData_<ContainerAllocator>  const> : public TrueType {};
template<class ContainerAllocator>
struct MD5Sum< ::ardrone2_mudd::navData_<ContainerAllocator> > {
  static const char* value() 
  {
    return "52f35305128af01a37ee8cd90d1f5912";
  }

  static const char* value(const  ::ardrone2_mudd::navData_<ContainerAllocator> &) { return value(); } 
  static const uint64_t static_value1 = 0x52f35305128af01aULL;
  static const uint64_t static_value2 = 0x37ee8cd90d1f5912ULL;
};

template<class ContainerAllocator>
struct DataType< ::ardrone2_mudd::navData_<ContainerAllocator> > {
  static const char* value() 
  {
    return "ardrone2_mudd/navData";
  }
...
template<class ContainerAllocator>
struct Definition< ::ardrone2_mudd::navData_<ContainerAllocator> > {
  static const char* value() 
  {
    return "uint16 tag\n\
uint16 size\n\
...
template<class ContainerAllocator> struct IsFixedSize< ::ardrone2_mudd::navData_<ContainerAllocator> > : public TrueType {};
} // namespace message_traits
} // namespace ros
...
template<class ContainerAllocator> struct Serializer< ::ardrone2_mudd::navData_<ContainerAllocator> >
{
...
template<class ContainerAllocator>
struct Printer< ::ardrone2_mudd::navData_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const  ::ardrone2_mudd::navData_<ContainerAllocator> & v) 
  {
    s << indent << "tag: ";
...
#endif // ARDRONE2_MUDD_MESSAGE_NAVDATA_H
