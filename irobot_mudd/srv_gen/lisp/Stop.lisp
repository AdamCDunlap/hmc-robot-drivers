...
(cl:defmethod cl:initialize-instance :after ((m <Stop-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Stop-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name irobot_mudd-srv:<Stop-request> is deprecated: use irobot_mudd-srv:Stop-request instead.")))

(cl:ensure-generic-function 'stop-val :lambda-list '(m))
(cl:defmethod stop-val ((m <Stop-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader irobot_mudd-srv:stop-val is deprecated.  Use irobot_mudd-srv:stop instead.")
  (stop m))
...
(cl:defmethod cl:initialize-instance :after ((m <Stop-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Stop-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name irobot_mudd-srv:<Stop-response> is deprecated: use irobot_mudd-srv:Stop-response instead.")))
