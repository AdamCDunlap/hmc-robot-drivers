...
(cl:defmethod cl:initialize-instance :after ((m <Leds-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Leds-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name irobot_mudd-srv:<Leds-request> is deprecated: use irobot_mudd-srv:Leds-request instead.")))

(cl:ensure-generic-function 'advance-val :lambda-list '(m))
(cl:defmethod advance-val ((m <Leds-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader irobot_mudd-srv:advance-val is deprecated.  Use irobot_mudd-srv:advance instead.")
  (advance m))

(cl:ensure-generic-function 'play-val :lambda-list '(m))
(cl:defmethod play-val ((m <Leds-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader irobot_mudd-srv:play-val is deprecated.  Use irobot_mudd-srv:play instead.")
  (play m))

(cl:ensure-generic-function 'color-val :lambda-list '(m))
(cl:defmethod color-val ((m <Leds-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader irobot_mudd-srv:color-val is deprecated.  Use irobot_mudd-srv:color instead.")
  (color m))

(cl:ensure-generic-function 'intensity-val :lambda-list '(m))
(cl:defmethod intensity-val ((m <Leds-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader irobot_mudd-srv:intensity-val is deprecated.  Use irobot_mudd-srv:intensity instead.")
  (intensity m))
...
(cl:defmethod cl:initialize-instance :after ((m <Leds-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Leds-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name irobot_mudd-srv:<Leds-response> is deprecated: use irobot_mudd-srv:Leds-response instead.")))
