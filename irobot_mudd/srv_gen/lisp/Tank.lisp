...
(cl:defmethod cl:initialize-instance :after ((m <Tank-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Tank-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name irobot_mudd-srv:<Tank-request> is deprecated: use irobot_mudd-srv:Tank-request instead.")))

(cl:ensure-generic-function 'left-val :lambda-list '(m))
(cl:defmethod left-val ((m <Tank-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader irobot_mudd-srv:left-val is deprecated.  Use irobot_mudd-srv:left instead.")
  (left m))

(cl:ensure-generic-function 'right-val :lambda-list '(m))
(cl:defmethod right-val ((m <Tank-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader irobot_mudd-srv:right-val is deprecated.  Use irobot_mudd-srv:right instead.")
  (right m))
...
(cl:defmethod cl:initialize-instance :after ((m <Tank-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Tank-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name irobot_mudd-srv:<Tank-response> is deprecated: use irobot_mudd-srv:Tank-response instead.")))
