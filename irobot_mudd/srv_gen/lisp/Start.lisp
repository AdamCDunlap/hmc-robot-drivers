...
(cl:defmethod cl:initialize-instance :after ((m <Start-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Start-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name irobot_mudd-srv:<Start-request> is deprecated: use irobot_mudd-srv:Start-request instead.")))

(cl:ensure-generic-function 'start-val :lambda-list '(m))
(cl:defmethod start-val ((m <Start-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader irobot_mudd-srv:start-val is deprecated.  Use irobot_mudd-srv:start instead.")
  (start m))
...
(cl:defmethod cl:initialize-instance :after ((m <Start-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Start-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name irobot_mudd-srv:<Start-response> is deprecated: use irobot_mudd-srv:Start-response instead.")))
