...
##    Can avoid obstacles in the front
#############################################
##    NOTE:
...
def rangeGUI():
    ...
    while rospy.is_shutdown() == False:
        ...
        for angle in range(REV):
            ...
            if x < CENTER - 20 and y > CENTER - 30 and y < CENTER + 10:
                D.left.append((x,y))
            elif x > CENTER + 20 and y > CENTER - 30 and y < CENTER + 10:
                D.right.append((x,y))
...
def wallFollow():
    ...
    try:
        ...
        # get the total number of blocked walls
